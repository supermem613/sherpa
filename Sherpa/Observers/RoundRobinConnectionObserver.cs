namespace Sherpa.Observers
{
    ...
    /// </summary>
    public class RoundRobinConnectionObserver : ConnectionObserver
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RoundRobinConnectionObserver"/> class.
        /// </summary>
        /// <param name="destination">The destination.</param>
        /// <param name="clientToServer">if set to <c>true</c> [is client to listener].</param>
        public RoundRobinConnectionObserver(Connection destination, bool clientToServer)
        {
